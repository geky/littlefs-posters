...
\tikzset{
    ...
    rbydtag/.style={
        draw,
        ultra thick,
        minimum width=0.6*\rbydnodewidth,
        minimum height=0.6*\rbydnodeheight,
        inner sep=0,
        outer sep=0,
        fill=bg,
        font=\large,
...
\newcommand{\rbyd}[2]{
    \begin{scope}[
        ...
        \node (#1_r0_0) [rbydtag, #2, anchor=south west] {$0$};
        \end{scope}
...
\newcommand{\rtree}[2]{
    \begin{scope}[
        ...
        \node (#1_r0_0) [rbydtag, #2, anchor=south west, shift={(1,0)}] {$0$};
...
\block[bodyinnersep=0pt]{}{
    ...
    \begin{tikzpicture}
        ...
        % Rbyd stuff
        \coordinate (rorigin) at (0,{5*\bnodeheight});
        \rlog{rlog}{right=(0/4)*\linewidth of rorigin};
        \rbyd{rbyd}{right=(1/4)*\linewidth of rorigin};
        \rtree{rtree}{right=(2/4)*\linewidth of rorigin};

        \draw[bbubbleptr] (rbyd_rtrunk) -- (rtree_rtrunk);
