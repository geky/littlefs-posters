...
nodes---optimal in terms of branching factor and storage usage, but
...
B-trees~\cite{btree} with red-black-yellow Dhara (rbyd) trees---a
self-balancing variant of the Dhara tree implemented in the
